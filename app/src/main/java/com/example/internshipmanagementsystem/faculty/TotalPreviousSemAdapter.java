...
class TotalPreviousSemAdapter extends RecyclerView.Adapter<TotalPreviousSemAdapter.ViewHolder>{

    private ArrayList<ApplyForInternshipModel> listdata;
    PrevoiusSemeterInternActivity internshipListActivity;

    // RecyclerView recyclerView;
    public TotalPreviousSemAdapter(PrevoiusSemeterInternActivity activity,ArrayList<ApplyForInternshipModel> listdata) {
