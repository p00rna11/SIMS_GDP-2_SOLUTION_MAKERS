...
class TotalCurrentSemAdapter extends RecyclerView.Adapter<TotalCurrentSemAdapter.ViewHolder> {

    private ArrayList<ApplyForInternshipModel> listdata;
    CurrentSemesterActivity internshipListActivity;

    // RecyclerView recyclerView;
    public TotalCurrentSemAdapter(CurrentSemesterActivity activity, ArrayList<ApplyForInternshipModel> listdata) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (myListData.getStatus().equalsIgnoreCase("APPROVE")) {
