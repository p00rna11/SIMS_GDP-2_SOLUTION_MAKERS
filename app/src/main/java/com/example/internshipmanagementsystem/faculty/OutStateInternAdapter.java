...
public class OutStateInternAdapter extends RecyclerView.Adapter<OutStateInternAdapter.ViewHolder> {

    private ArrayList<ApplyForInternshipModel> listdata;
    OutStateInternActivity internshipListActivity;

    public OutStateInternAdapter(OutStateInternActivity outStateInternActivity, ArrayList<ApplyForInternshipModel> arrayList) {
