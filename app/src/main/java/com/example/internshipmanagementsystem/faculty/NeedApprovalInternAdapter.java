...
public class NeedApprovalInternAdapter extends RecyclerView.Adapter<NeedApprovalInternAdapter.ViewHolder> {

    private ArrayList<ApplyForInternshipModel> listdata;
    NeedApprovalsActivity internshipListActivity;

    public NeedApprovalInternAdapter(NeedApprovalsActivity outStateInternActivity, ArrayList<ApplyForInternshipModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.studentStatus.setText(listdata.get(position).getStatus().toString());
